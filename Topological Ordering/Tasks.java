...
public class Tasks {
    ...
    public static boolean isPossible(int tasks, int[][] prerequisites) {
    ...
    public static void main(String[] args) {
        boolean result = Tasks.isPossible(3, new int[][]
            {new int[] {0,1}, new int[] {1,2}});
        System.out.println(result);

        result = Tasks.isPossible(3, new int[][]
            {new int[] {0,1}, new int[] {1,2}, new int[] {2,0}});
        System.out.println(result);

        result = Tasks.isPossible(6, new int[][]
